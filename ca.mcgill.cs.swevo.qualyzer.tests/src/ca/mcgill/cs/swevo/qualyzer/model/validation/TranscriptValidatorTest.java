...
public class TranscriptValidatorTest
{
	...
	public void testAttachedParticipants()
	{
		...
		assertFalse(lValidator.isValid());
		assertEquals(Messages.getString("model.validation.TranscriptValidator.selectOne"),lValidator.getErrorMessage());
	}
	...
	public void testBogusAudioFile()
	{
		...
		assertFalse(lValidator.isValid());
		assertEquals(Messages.getString("model.validation.TranscriptValidator.enterAudioName"),lValidator.getErrorMessage());
	}
